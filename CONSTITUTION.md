...
this repo focuses on the frontend. the project is made up of two sub-projects, each in their own repo, for now: frontend and pipeline.
the pipeline ingests/scrapes/extracts data and transforms it. this runs independently.
the frontend (this pipeline) is a simple static website which is built based on this data.
